...
import (
	...
	"gitee.com/geektime-geekbang/geektime-go/web/middlewares/accesslog"
	"gitee.com/geektime-geekbang/geektime-go/web/middlewares/cors"
	"gitee.com/geektime-geekbang/geektime-go/web/middlewares/opentelemetry"
	"gitee.com/geektime-geekbang/geektime-go/web/middlewares/prometheus"
	"gitee.com/geektime-geekbang/geektime-go/web/middlewares/recover"
	"go.uber.org/zap"
	"net/http"
)
